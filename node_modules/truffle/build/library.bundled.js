...
"use strict";
module.exports = JSON.parse('{"name":"@truffle/core","description":"Core code for Truffle command line tool","license":"MIT","author":"consensys.net","homepage":"https://github.com/trufflesuite/truffle#readme","repository":{"type":"git","url":"https://github.com/trufflesuite/truffle.git","directory":"packages/core"},"bugs":{"url":"https://github.com/trufflesuite/truffle/issues"},"version":"5.10.0","bin":{"truffle":"./cli.js","truffle-exec":"./exec.js"},"scripts":{"prepare":"exit 0","test":"mocha ./test/** ./test/**/*"},"dependencies":{"@truffle/artifactor":"^4.0.192","@truffle/box":"^2.1.78","@truffle/code-utils":"^3.0.3","@truffle/codec":"^0.15.3","@truffle/compile-common":"^0.9.6","@truffle/compile-solidity":"^6.0.72","@truffle/config":"^1.3.58","@truffle/contract":"^4.6.24","@truffle/dashboard":"^0.3.23","@truffle/db-loader":"^0.2.29","@truffle/debug-utils":"^6.0.52","@truffle/debugger":"^11.1.5","@truffle/decoder":"^5.5.0","@truffle/deployer":"^3.3.20","@truffle/environment":"^0.2.153","@truffle/error":"^0.2.1","@truffle/expect":"^0.1.6","@truffle/fetch-and-compile":"^0.5.49","@truffle/from-hardhat":"^0.2.13","@truffle/hdwallet":"^0.1.3","@truffle/interface-adapter":"^0.5.34","@truffle/migrate":"^3.3.41","@truffle/plugins":"^0.2.14","@truffle/preserve":"^0.2.16","@truffle/promise-tracker":"^0.1.6","@truffle/provider":"^0.3.10","@truffle/provisioner":"^0.2.81","@truffle/require":"^2.1.36","@truffle/resolver":"^9.0.46","@truffle/source-fetcher":"^1.0.38","@truffle/spinners":"^0.2.4","@truffle/test":"^0.2.0","@truffle/workflow-compile":"^4.0.64","JSONStream":"^1.3.5","address":"^1.1.2","chai":"^4.2.0","colors":"1.4.0","command-exists":"^1.2.8","conf":"^10.0.2","debug":"^4.3.1","del":"^2.2.0","ethereum-cryptography":"1.1.2","fs-extra":"^9.1.0","ganache":"7.8.0","get-port":"^5.1.1","get-random-values":"^1.2.2","glob":"^7.1.6","inquirer":"8.2.2","iter-tools":"^7.5.0","js-interpreter":"2.2.0","lodash":"^4.17.21","mocha":"10.1.0","node-emoji":"^1.8.1","original-require":"^1.0.1","sane":"^4.0.2","semver":"7.3.7","source-map-support":"^0.5.19","spawn-args":"0.2.0","tmp":"^0.2.1","universal-analytics":"^0.4.17","uuid":"^9.0.0","web3":"1.10.0","web3-utils":"1.10.0","xregexp":"^4.2.4","yargs":"^13.3.0"},"devDependencies":{"@truffle/blockchain-utils":"^0.1.8","app-module-path":"^2.2.0","chai-as-promised":"^7.1.1","memorystream":"^0.3.1","sinon":"^9.0.2"},"publishConfig":{"access":"public"},"authors":[{"name":"Tim Coulter","email":"tim@trufflesuite.com","url":"https://github.com/tcoulter"}],"namespace":"consensys","gitHead":"cb01f46c8df6b8aa693856ecdf7c0f37159c4864"}');
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [5158,5784,3618,8074,5674,6127,6674,6857,406,6889,6434,1324,8716,2765,5358,3983,4866,5658,1698,6446,4886,560,4914,4877,6062,4738,708,8569,553,4273,102,4317,7017,2478,8852], () => (__webpack_require__(489244)))
